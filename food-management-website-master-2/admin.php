...
<body>
    ...
    <div class="d-flex col-12 col-lg-10 gap-5 mx-auto align-items-center justify-content-center flex-wrap ">
        <a href="add_dish.php" class="col-10 col-lg-4 bg-green p-5 text-center text-decoration-none btn-green btn rounded-pill">
            <h1>Add a Dish</h1>
        </a>
        ...
        <a href="delete_restaurant.php" class="col-10 col-lg-4 bg-danger p-5 text-center text-decoration-none text-white btn rounded-pill">
            <h1>Delete Restaurant</h1>
        </a>
        <a href="manage_orders.php" class="col-10 col-lg-4 bg-primary p-5 text-center text-decoration-none text-white btn rounded-pill">
            <h1>Manage Orders</h1>
        </a>
    </div>
